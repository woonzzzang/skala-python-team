...
### 주요 수치형 변수 기술통계
| column         |   count |      mean |       std |   min |     Q1 |   median |     Q3 |    IQR |            max |   missing |   missing_ratio(%) |   nunique |   skewness |   kurtosis |   zero_ratio(%) |   outlier_count |
|:---------------|--------:|----------:|----------:|------:|-------:|---------:|-------:|-------:|---------------:|----------:|-------------------:|----------:|-----------:|-----------:|----------------:|----------------:|
| age            |   32537 |     38.59 |     13.64 |    17 |     28 |       37 |     48 |     20 |    90          |         0 |                  0 |        73 |       0.56 |      -0.17 |            0    |             142 |
| fnlwgt         |   32537 | 189781    | 105556    | 12285 | 117827 |   178356 | 236993 | 119166 |     1.4847e+06 |         0 |                  0 |     21648 |       1.45 |       6.22 |            0    |             993 |
| education-num  |   32537 |     10.08 |      2.57 |     1 |      9 |       10 |     12 |      3 |    16          |         0 |                  0 |        16 |      -0.31 |       0.62 |            0    |            1193 |
| capital-gain   |   32537 |   1078.44 |   7387.96 |     0 |      0 |        0 |      0 |      0 | 99999          |         0 |                  0 |       119 |      11.95 |     154.68 |           91.66 |            2712 |
| capital-loss   |   32537 |     87.37 |    403.1  |     0 |      0 |        0 |      0 |      0 |  4356          |         0 |                  0 |        92 |       4.59 |      20.36 |           95.33 |            1519 |
| hours-per-week |   32537 |     40.44 |     12.35 |     1 |     40 |       40 |     45 |      5 |    99          |         0 |                  0 |        94 |       0.23 |       2.92 |            0    |            9002 |
...
### 추가 t-test (정규성/등분산성 확인 후 검정 방법 자동 선택)
  - income (>50K vs <=50K) x age: Mann-Whitney U, 통계량=132460134.0000, p-value=0.0000, Cohen's d=0.602, 유의함
  - sex (Male vs Female) x hours-per-week: Mann-Whitney U, 통계량=153245112.0000, p-value=0.0000, Cohen's d=0.503, 유의함
  - workclass (Private vs Self-emp-not-inc) x hours-per-week: Mann-Whitney U, 통계량=23803720.5000, p-value=0.0000, Cohen's d=-0.292, 유의함
  - income (>50K vs <=50K) x education-num: Mann-Whitney U, 통계량=138822550.0000, p-value=0.0000, Cohen's d=0.837, 유의함
...
### 카이제곱 독립성 검정 (선택적 추가 분석)
  ...
  - workclass x income: chi2=826.44, p-value=0.0000, 유의함
  - marital-status x income: chi2=6510.33, p-value=0.0000, 유의함
  - race x income: chi2=330.94, p-value=0.0000, 유의함
  - native-country x income: chi2=202.83, p-value=0.0000, 유의함

## 5. 모델링
- 사용한 feature: 수치형 ['age', 'fnlwgt', 'education-num', 'capital-gain', 'capital-loss', 'hours-per-week'], 범주형 ['workclass', 'marital-status', 'occupation', 'relationship', 'race', 'sex', 'native-country']
...
- 비교한 후보 모델:
  - LogisticRegression: Accuracy=0.8085, Precision=0.5678, Recall=0.8603, F1=0.6841, ROC-AUC=0.9095
  - RandomForest: Accuracy=0.8637, Precision=0.7593, Recall=0.6358, F1=0.6921, ROC-AUC=0.9101
- 최종 선택 모델: LogisticRegression
  (F1-score를 우선 기준으로 하되, 성능 차이가 근소하면 해석 가능성이 더 좋은 LogisticRegression을 선택)
- Accuracy : 0.8085
- Precision: 0.5678
- Recall   : 0.8603
- F1-score : 0.6841
...
- 정적 차트 PNG: output/figures/income_distribution.png, output/figures/numeric_eda.png, output/figures/additional_distributions.png, output/figures/categorical_eda.png, output/figures/correlation_heatmap.png, output/figures/confusion_matrix.png, output/figures/roc_curve.png
- Plotly 인터랙티브 차트 HTML: output/interactive/adult_income_analysis.html, output/interactive/education_income_ratio.html, output/interactive/occupation_income_ratio.html, output/interactive/occupation_facet_scatter.html, output/interactive/occupation_education_income_treemap.html, output/interactive/sex_workclass_income_parallel_categories.html
